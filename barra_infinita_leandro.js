document.addEventListener('DOMContentLoaded', (event) => {
  ...
  function calcularE() {
    ...
    }).catch((err) => console.log('Error typesetting formulas: ' + err.message));
  }
  ...
  function mostrarPassoAPasso() {
    ...
    // Renderiza a fórmula com MathJax
    MathJax.typesetPromise([passoAPassoDiv]).then(() => {
      console.log('Step-by-step calculation has been rendered.');
    }).catch((err) => console.log('Error typesetting step-by-step: ' + err.message));
  }